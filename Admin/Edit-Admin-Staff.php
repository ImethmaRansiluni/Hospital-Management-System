...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($conn, $update_sql)) {
        header("Location: View-Admin-1Staff.php?staff_id=$staff_id");  // Redirect to the profile page after update
        exit();
    } else {
...
<div class="container">
    <div class="staff-info">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <p><label>NIC:</label> <input type="text" name="nic" value="<?php echo $staff['staff_nic']; ?>" required></p>
            <p><label>Email:</label> <input type="email" name="staff_email" value="<?php echo $staff['staff_email']; ?>" required></p>
            <p><label>Contact:</label> <input type="text" name="contact_info" value="<?php echo $staff['staff_contact']; ?>" required></p>
    ...
    <div class="staff-image">
        ...
        <div class="edit-profile">
            <button type="button"><a href="View-Admin-Staff.php" style="text-decoration: none; color: white;">Back</a></button>
        </div>
    </div>
</div>
