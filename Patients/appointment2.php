...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_query = "SELECT * FROM appointment WHERE appointment_date = '$appointment_date' AND nic = '$nic' 
    AND staff_id = '$staff_id'";
    $check_result = mysqli_query($conn, $check_query);

    if (mysqli_num_rows($check_result) == 0) {
        // Proceed with appointment insertion
        $sql = "INSERT INTO appointment (staff_id, patient_APemail, nic, staff_department, branch, appointment_date, 
        appointment_time) 
                VALUES ('$staff_id', '$patient_email', '$nic', '$staff_department', '$branch', '$appointment_date', 
                '$appointment_time')";
...
<head>
    ...
    <link rel="StyleSheet" href="CSSP/StyleSheet-appointment2.css">
</head>
